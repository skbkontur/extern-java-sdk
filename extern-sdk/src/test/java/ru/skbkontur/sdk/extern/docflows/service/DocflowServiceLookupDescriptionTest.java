...
public class DocflowServiceLookupDescriptionTest {
  ...
  private void checkResponseCode(int code) {
    ...
    QueryContext<DocumentDescription> documentDescriptionQueryContext = engine.getDocflowService()
  ...
  private DocumentDescription getDocumentDescriptionAsync() {
    try {
      return engine.getDocflowService().lookupDescriptionAsync(StandardValues.ID, StandardValues.ID)
          .get().get();
