...
public class CheckResultDataDto {
	...
	public ru.skbkontur.sdk.extern.model.CheckResultData fromDto(ru.skbkontur.sdk.extern.service.transport.swagger.model.CheckResultData dto) {
		ru.skbkontur.sdk.extern.model.CheckResultData checkResultData = null;
		if (dto != null) {
			checkResultData = new ru.skbkontur.sdk.extern.model.CheckResultData();
	...
	public ru.skbkontur.sdk.extern.service.transport.swagger.model.CheckResultData toDto(ru.skbkontur.sdk.extern.model.CheckResultData checkResultData) {
		ru.skbkontur.sdk.extern.service.transport.swagger.model.CheckResultData dto = null;
		if (checkResultData != null) {
			dto = new ru.skbkontur.sdk.extern.service.transport.swagger.model.CheckResultData();
