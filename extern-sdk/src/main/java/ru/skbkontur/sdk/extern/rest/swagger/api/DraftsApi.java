...
public class DraftsApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void draftDocumentsGetDocumentPrint(UUID accountId, UUID draftId, UUID documentId) throws ApiException {
        draftDocumentsGetDocumentPrintWithHttpInfo(accountId, draftId, documentId);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> draftDocumentsGetDocumentPrintWithHttpInfo(UUID accountId, UUID draftId, UUID documentId) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call draftDocumentsGetDocumentPrintAsync(UUID accountId, UUID draftId, UUID documentId, final ApiCallback<Void> callback) throws ApiException {
