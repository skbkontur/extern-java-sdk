...
import ru.skbkontur.sdk.extern.rest.swagger.model.DocflowDescription;
...
public class Docflow {
  ...
  **/
  ...
  public Docflow status(Urn status) {
    this.status = status;
    return this;
  }
  ...
  **/
  @ApiModelProperty(value = "")
  public Urn getStatus() {
    return status;
  }

  public void setStatus(Urn status) {
    this.status = status;
  }
